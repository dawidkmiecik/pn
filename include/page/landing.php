	...
	<body>
		<div class="container"> 
			<div class="row landingLogo">
				<div class="col-md-4 col-md-offset-2" style="border: solid 1px yellow;">
		...
		<div class="container-fluid landing" style="border: solid 1px yellow;">
			<div class="container" style="border: solid 1px yellow;"> 
				<div class="row" >
					<div class="col-md-12">
						<form class="col-md-4 col-md-offset-2" style="border: solid 1px yellow;"  role="form">
		...
		<div class="container"> 
			<div class="row">
				<div class="col-md-4" style="border: solid 1px yellow;">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="embed-responsive embed-responsive-16by9">
					  	<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/c4BLVznuWnU"></iframe>	
					</div>
				</div>
			</div>
		</div>
